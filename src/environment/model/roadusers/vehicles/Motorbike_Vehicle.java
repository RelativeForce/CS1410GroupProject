...
/**
 * The <code>Motorbike</code> class is a subclass of the {@link Vehicle} class,
 * which models a motor bike.
 * 
 * <p>
...
public final class Motorbike_Vehicle extends Vehicle {
	 ...
	 * 
	 * <p>
	 * Initialise a new <code>Motorbike</code> object where the {@link Vehicle}
	 * superclass is initialised with the {@link Vehicle#size} of
	 * {@link #UNIT_SIZE} ({@value #UNIT_SIZE}), and the
	...
	public Motorbike_Vehicle() {
		...
		/*
		 * Invoke the superclass constructor with the physical size of the
		 * Motorbike and the tank size of the Motorbike.
		 */
	...
	/**
	 * Create a new instance of the {@link Motorbike_Vehicle} with a specified
	 * size, tank and fuel level.
	 * 
	 * <p>
	 * This constructor is only used for creating clones of the
	 * {@link Motorbike_Vehicle} using the {@link Vehicle#getCloneConstructor()}
	 * method.
	 * </p>
	 * 
	 * @param size
	 *            The size of the {@link Motorbike_Vehicle}.
	 * @param tankSize
	 *            The tank size of the {@link Motorbike_Vehicle}.
	 * @param fuelLevel
	 *            The current fuel level of the {@link Motorbike_Vehicle}.
	 * @param fuelType
	 *            The fuel type of the {@link Motorbike_Vehicle}.
	 */
	private Motorbike_Vehicle(final double size, final int tankSize, final int fuelLevel, final FuelType fuelType) {
	 ...
	 * 
	 * <p>
	 * Compare an object agains the <code>Motorbike</code> object to check of
	 * they are logically equal. First check if the object is an instance of the
	 * <code>
	 * Motorbike</code> class, if so, then use the
	 * {@link Vehicle#equals(Object)} method to test the objects
	 * {@link Vehicle#size} and {@link Vehicle#tankSize} attributes; if the
	 * object is not an instance of <code>Motorbike</code> then the object
	 * cannot be equal to any <code>Motorbike</code>.
	 * </p>
	 * 
	 * @param o
	...
	public boolean equals(Object o) {
		...
		/*
		 * Check if the object an instance of the Motorbike class, if it is then
		 * check the equality in the Vehicle equals method; otherwise the result
		 * is false.
		 */
	...
	public String toString() {
		 ...
		 * size and tank size of the Motorbike from the Vehicle class'
		 * toString() method.
		 */

		return new StringBuilder().append("Motorbike. ").append(super.toString()).toString();
	}
