 ...
 * {@link Vehicle#tankSize} attributes from the {@link Vehicle} class, which are
 * initialised upon creation of the <code>FamilySedan</code>.
 * </p>
 * 
 * <p>
...
public final class FamilySedan_Vehicle extends Vehicle {
	 ...
	 * {@link Vehicle} constructor, where the {@link Vehicle#size} is set as
	 * {@link #UNIT_SIZE} ({@value #UNIT_SIZE}) and the {@link Vehicle#tankSize}
	 * is set to a minimum of {@link #MIN_TANK_SIZE} ({@value #MIN_TANK_SIZE}),
	 * with a range of {@link #TANK_SIZE_RANGE} ({@value #TANK_SIZE_RANGE}).
	 * </p>
	 * 
	 * <p>
	...
	/**
	 * Create a new instance of the {@link FamilySedan_Vehicle} class with a
	 * specified size, tank size, fuel level and fuel type.
	 * 
	 * <p>
	 * This constructor is only used for creating clones of the
	 * {@link FamilySedan_Vehicle} using the
	 * {@link Vehicle#getCloneConstructor()} method.
	 * </p>
	 * 
	 * @param size
	 *            The size of the {@link FamilySedan_Vehicle}.
	 * @param tankSize
	 *            The tank size of the {@link FamilySedan_Vehicle}.
	 * @param fuelLevel
	 *            The current fuel level of the {@link FamilySedan_Vehicle}.
	 * @param fuelType
	 *            The fuel type of the {@link FamilySedan_Vehicle}.
	 */
	private FamilySedan_Vehicle(final double size, final int tankSize, final int fuelLevel, final FuelType fuelType) {
	 ...
	 * {@link Vehicle#equals(Object)} method will determine if the object is
	 * equal to the <code>FamilySedan</code>, otherwise, if the object is not an
	 * instance of the <code>FamilySedan</code> class, the object cannot be
	 * equal to any <code>
	 * FamilySedan</code>.
	 * </p>
	 * 
	...
	public boolean equals(Object o) {
		...
		/*
		 * Check if o is a FamilySedan, if so, determine the equality in the
		 * superclass otherwise o cannot be equal to a FamilySedan.
		 */
	...
	/**
	 * Get the <code>String</code> representation of the
	 * <code>FamilySedan</code>.
	 * 
	 * <p>
	...
	public String toString() {
		...
		return new StringBuilder().append("FamilySedan. ").append(super.toString()).toString();
	}
	 ...
	 * 
	 * <p>
	 * Create a logical equivalent of the {@link FamilySedan_Vehicle} object
	 * which has an identical state to that of the original object.
	 * </p>
	 * 
