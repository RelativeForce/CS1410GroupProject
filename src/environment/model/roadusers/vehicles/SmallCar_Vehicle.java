...
/**
 * The <code>SmallCar</code> class is a subclass of the {@link vehicle} class,
 * which models a car.
 * 
 * <p>
...
public final class SmallCar_Vehicle extends Vehicle {
	...
	/**
	 * Create a new {@link SmallCar_Vehicle} with a specified size, tank and
	 * fuel level.
	 * 
	 * <p>
	 * This constructor is only for creating deep clones of the
	 * {@link SmallCar_Vehicle} in association with the
	 * {@link Vehicle#getCloneConstructor()} method.
	 * </p>
	 * 
	 * @param size
	 *            The size of the {@link SmallCar_Vehicle}.
	 * @param tankSize
	 *            The tank size of the {@link SmallCar_Vehicle}.
	 * @param fuelLevel
	 *            The current fuel level of the {@link SmallCar_Vehicle}.
	 * @param fuelType
	 *            The fuel type of the {@link SmallCar_Vehicle}
	 */
	private SmallCar_Vehicle(final double size, final int tankSize, final int fuelLevel, final FuelType fuelType) {
	 ...
	 * instance of the {@link SmallCar_Vehicle} class, the
	 * {@link Vehicle#equals(Object)} method will determine if the object is
	 * equal to the <code>SmallCar</code>; if the object is not an instance of
	 * the <code>SmallCar</code> class then object cannot be equal to the
	 * <code>SmallCar</code> as the object is not a <code>SmallCar</code>.
	 * </p>
	 * 
	 * @param o
	 ...
	 * 
	 * <p>
	 * Get the <code>String</code> representing the <code>SmallCar</code>
	 * containing a description of the <code>SmallCar</code>. The
	 * {@link Vehicle#toString()} from the {@link Vehicle} is used to get the
	 * details of the {@link Vehicle#size} and {@link Vehicle#tankSize}.
	 * </p>
	 * 
	 * <p>
	 * Format:
	...
	public String toString() {
		...
		/*
		 * The name of the SmallCar, the size and tank size of the Vehicle, get
		 * the size and the tank size from the Vehicle class.
		 */

		return new StringBuilder().append("Small car. ").append(super.toString()).toString();
	}
